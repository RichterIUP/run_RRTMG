...
def create_input_rrtmg_sw(height_prof, press_prof, t_prof, humd_prof, solar_zenith_angle, lat=75., clouds=0, albedo_dir=0.3, albedo_diff=0.3, co2=None, n2o=None, ch4=None, juldat=150):
    # Record 1.1
...
def main(lat, lon, sza, cwp, wpi, rl, ri, cloud, z, t, q, p, dcwp, dwpi, drl, dri, co2, n2o, ch4, albedo_dir, albedo_diff, iceconc, semiss, clt, diff_lwp=0.0, flag_lwc=0, flag_iwc=0, flag_reff=0, flag_reffice=0, fname="out.nc"):
